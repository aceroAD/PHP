...
class EjemploPlantillas extends AbstractController{
     ...
     */
	 ...
	 /**
     * @Route("/listavinculos/", name="listavinculos")	 
     */
	  public function listaVinculos(){		
		return $this->render('listavinculos.html.twig');
	 }
	 /**
     * @Route("/listavinculosp/{nombre}/{num}", name="listavinculosp")	 
     */
	  public function listaVinculosP($nombre, $num){		
		return $this->render('listavinculosp.html.twig', array ( 'nombre' => $nombre,
																 'num' => $num));
	 }
