	...
	<body>
		<?php require 'cabecera.php';			
			...
			foreach($productos as $producto){
				...
				<td><form action = 'eliminar.php' method = 'POST'><input name = 'unidades' type='number' min = '1' value = '1'><input type = 'submit' value='Eliminar'></td><input name = 'cod' type='hidden' value = '$cod'>  </form></tr>";
