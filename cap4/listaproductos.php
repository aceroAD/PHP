	...
	<body>
		<?php require 'cabecera.php';
			...
			foreach($productos as $producto){
				...
				<td><form action = 'anadir.php' method = 'POST'><input name = 'unidades' type='number' min = '1' value = '1'><input type = 'submit' value='Comprar'></td><input name = 'cod' type='hidden' value = '$cod'>  </form></tr>";
